...
function DataConverter(outputDataType) {
...
DataConverter.prototype.create = function(w,h) {
  ...
  this.inputHeader = 1;//$('<div class="groupHeader" id="inputHeader"><p class="groupHeadline">Input CSV or tab-delimited data. <span class="subhead"> Using Excel? Simply copy and paste. No data on hand? <a href="#" id="insertSample">Use sample</a></span></p></div>');
  this.inputTextArea = 1;//$('<textarea class="textInputs" id="dataInput"></textarea>');
  ...
  this.outputHeader = 1;//$(outputHeaderText);
  this.outputTextArea = 1;//$('<textarea class="textInputs" id="dataOutput"></textarea>');
...
DataConverter.prototype.convert = function(data) {
  ...
  if (this.inputText.length > 0) {
    ...
    var DataGridRenderer = require("./DataGridRenderer.js")
